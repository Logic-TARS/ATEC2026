...
# Usage: ./scripts/train/train-env.sh --task <env_id> [extra_args...]
#
# Examples:
#   ./scripts/train/train-env.sh --task ATEC-Isaac-Velocity-Flat-TaskF-Unitree-B2W-Piper-v0 \
#       --headless --enable_cameras --disable_fabric --num_envs 64 --max_iterations 1000
#
#   ./scripts/train/train-env.sh --task ATEC-Isaac-Velocity-Flat-Omni-B2W-Piper-v0 \
...
Common extra args (forwarded to tools/atec/rsl_rl/train.py):
