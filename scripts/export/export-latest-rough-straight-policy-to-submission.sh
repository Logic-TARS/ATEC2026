...
experiment_root="outputs/rsl_rl/unitree_b2_rough_straight"
...
target_policy="submission/policy.pt"
backup_policy="submission/policy_before_rough_straight_$(date +%Y%m%d_%H%M%S).pt"
