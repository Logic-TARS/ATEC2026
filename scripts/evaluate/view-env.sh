...
# Usage: ./scripts/evaluate/view-env.sh --env_cfg <module_path>:<ClassName> [--video] [--num_envs N]
#
# Examples:
#   ./scripts/evaluate/view-env.sh \\
...
python /home/1ctnltug/atec2026/tools/atec/view_env.py "$@"
