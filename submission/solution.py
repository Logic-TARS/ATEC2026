...
class AlgSolution:
    ...
    def _default_policy_path(self) -> str:
        ...
        if self._policy_mode != self.POLICY_MODE_B2W_LOCOMOTION_56D:
            return os.path.join(submission_dir, "policy.pt")

        preferred_path = os.path.join(submission_dir, "policy_b2w_locomotion_56d.pt")
        if os.path.exists(preferred_path):
            return preferred_path
        return os.path.join(submission_dir, "policy_handover56.pt")
