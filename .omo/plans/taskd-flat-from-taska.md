# taskd-flat-from-taska - Work Plan
...
- Evidence: .omo/evidence/task-<N>-taskd-flat-from-taska.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-taskd-flat-from-taska.<ext>
